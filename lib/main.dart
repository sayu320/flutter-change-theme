...
import 'package:flutter_theme_change/provider/theme_provider.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          onPressed: () {
           ...
           icon: Icon(_themeProvider.currentTheme == ThemeEnum.Light ? Icons.light_mode : Icons.dark_mode,
           ),
           ),
           ],
      ),
